  ...
  return (
    <div className="h-full flex flex-col font-mono" style={{ background: '#0B0B0F' }}>
      ...
      >
        ...
        <span className="text-[10px] text-muted flex-1">assistant.sh — powered by Gemini 2.5 Flash</span>
      ...
      <div className="flex-1 overflow-auto px-4 py-3 space-y-3">
        ...
        {messages.length === 0 && (
          ...
          >
            ...
            <div className="text-sm text-gray-300 leading-relaxed pl-2 border-l-2" style={{ borderColor: '#00FFB340' }}>
              Hey. Ask me anything about projects, AI tools, or working together.
            </div>

            {/* Suggestions */}
            <div className="space-y-1 pt-1">
              <div className="text-[9px] text-muted uppercase tracking-wider">Quick questions</div>
        ...
        {limitReached && (
          ...
          >
            <div className="text-xs text-yellow-400 font-semibold mb-1">Demo limit reached.</div>
      ...
      >
        ...
        <input
          ...
          placeholder={limitReached ? 'Demo limit reached.' : 'Ask about projects, AI tools or collaboration...'}
        ...
        <button
          ...
          className="text-[10px] px-2 py-1 rounded border transition-all flex-shrink-0"
          style={{
