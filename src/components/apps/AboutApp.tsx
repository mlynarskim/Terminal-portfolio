...
export default function AboutApp() {
  ...
  const lines = [
    ...
    { type: 'blank' },
    { type: 'comment', text: '/*' },
    ...t.about.bio.map((line) => ({ type: 'comment', text: ` * ${line}` })),
    { type: 'comment', text: ' */' },
    { type: 'blank' },
    ...
    { type: 'prop', key: 'iOS', value: '["Swift", "SwiftUI", "Xcode Cloud"]', color: '#60A5FA' },
    { type: 'prop', key: 'crossPlatform', value: '["React Native", "Flutter", "TypeScript"]', color: '#34D399' },
    { type: 'prop', key: 'web', value: '["WordPress", "WooCommerce", "React"]', color: '#38BDF8' },
    { type: 'prop', key: 'backend', value: '["Firebase", "Google Cloud", "Node.js"]', color: '#F97316' },
    { type: 'prop', key: 'aiTools', value: '["Claude API", "Gemini API", "Make.com"]', color: '#C084FC' },
